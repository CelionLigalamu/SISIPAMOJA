KENYA_COUNTIES = {
    ...
    "Mandera": [
        ...
        "Mandera South", "Lafey", "Mandera East"
    ],
    "Marsabit": [
    ...
    "Embu": [
        "Manyatta", "Runyenjes", "Mbeere South",
        "Mbeere North"
    ],
    "Kitui": [
    ...
    "Makueni": [
        "Mbooni", "Kilome", "Kaiti", "Makueni",
        "Kibwezi West", "Kibwezi East"
    ],
    "Nyandarua": [
    ...
    "Kiambu": [
        ...
        "Thika Town", "Ruiru", "Githunguri", "Kiambu",
    ...
    "Trans Nzoia": [
        "Kwanza", "Endebess", "Saboti", "Kiminini",
        "Cherangany"
    ],
    "Uasin Gishu": [
    ...
    "Nakuru": [
        ...
        "Rongai", "Bahati", "Nakuru Town West",
        "Nakuru Town East"
    ],
    "Narok": [
    ...
    "Kakamega": [
        ...
        "Matungu", "Butere", "Khwisero", "Shinyalu",
        "Ikolomani"
    ],
    "Vihiga": [
    ...
    "Bungoma": [
        "Mt Elgon", "Sirisia", "Kabuchai", "Bumula",
